...
on average and MC dropout fails to reduce it (relative $\Delta$
$-2.2\%$ to $+12.5\%$ across the eight datasets, median $+1\%$),
confirming that parameter-variance methods miss the data-resampling
axis.
...
\begin{itemize}\itemsep0pt
  ...
  \item $K$-bootstrap bagging~\citep{TODO_breiman1996} reduces argmax
        ...
        disagreement by another factor of ${\sim}8$.  On a 10-dataset comparison across the overlap
