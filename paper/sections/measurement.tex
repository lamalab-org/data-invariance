...
canonical seeds ($\canonicalSeed$, $7$, $42$) for both the headline
chemistry-MLP comparison and the pretrained-backbone scope checks
(GIN, ChemBERTa, Waterbirds); magnitudes quoted in prose are
across-seed means and the $\lambda$-selection rule picks
