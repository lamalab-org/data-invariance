...
fragility counts disagreements before any averaging.  We pre-screen
...
\paragraph{Fragility correlates with task difficulty, but is not
explained by it.}
...
benchmarks --- harder tasks show more fragility.  At the
per-method level, decoupling: deep ensembles raise mean accuracy by
$\deepEnsAccDelta$\,pp without reducing fragility, while twin-bootstrap
cuts fragility a median $\twinMedianReduction\%$ at $\twinAccDelta$\,pp
mean accuracy cost (Table~\ref{tab:main}).  Fragility is not a
