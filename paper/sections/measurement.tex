...
benchmarks --- harder tasks show more churn.  This is not a
confound; the per-method picture is decoupled
...
across-replicate means; the $\lambda$-selection rule picks
$\lambda{=}300$ on every replicate independently
