...
HPARAMS = {
    ...
    "cyp2c9_substrate":   {"lr": 1e-3, "batch_size": 64, "epochs": 30, "discovery_epochs": 5},
    "cyp2d6_substrate":   {"lr": 1e-3, "batch_size": 64, "epochs": 30, "discovery_epochs": 5},
    "cyp3a4_substrate":   {"lr": 1e-3, "batch_size": 64, "epochs": 30, "discovery_epochs": 5},
    "hiv":               {"lr": 1e-3, "batch_size": 256, "epochs": 20, "discovery_epochs": 5},
    "clintox":           {"lr": 1e-3, "batch_size": 64,  "epochs": 30, "discovery_epochs": 5},
    "esol_reg":          {"lr": 1e-3, "batch_size": 64,  "epochs": 50, "discovery_epochs": 5},
    "freesolv_reg":      {"lr": 1e-3, "batch_size": 32,  "epochs": 50, "discovery_epochs": 5},
    "lipo_reg":          {"lr": 1e-3, "batch_size": 64,  "epochs": 50, "discovery_epochs": 5},
